  ...
  settings(settings)
{
  ...
  Q3WhatsThis::add(editMinPoints, QString(tr("Select a minimum number of points in a segment.\n\n"
  ...
  Q3WhatsThis::add(checkFillCorners, QString(tr("Fill corners.\n\n"
  ...
  Q3WhatsThis::add(comboLineSize, QString(tr("Select a size for the lines drawn along a segment")));
  ...
  Q3WhatsThis::add(comboLineColor, QString(tr("Select a color for the lines drawn along a segment")));
  ...
  Q3WhatsThis::add(previewCanvasView, QString(tr("Preview window shows the shortest line that can be segment filled, "
